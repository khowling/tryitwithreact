      ...
      return new Promise( function(resolve, reject)  {
        ...
        if (!form) {
          ...
          var validateSetFields = function (isInsert, form, dataval, embedField, allowchildform) {
            return asyncfn(function *(isInsert, form, dataval, embedField, allowchildform) {
              ...
              for (let rv of reqval) { // for each data record
                ...
                for (let propname in rv) { // for each property in data object
                  ...
                  if ('error' in tcres)
                    ...
                    let dynamic_fields = yield jexl.eval(tcres.dynamic_field.fieldmeta_el, {rec: rv, appMeta: FORM_DATA});
            ...
            })(isInsert, form, dataval, embedField, allowchildform);
          };
          ...
          if (isEmbedded || !isInsert) {
            ...
            exps.find (formid, parent, {_id: new ObjectID(userdoc._id)}, true, true).then(existing_rec => {
              ...
              if (isEmbedded)  {  // its embedded, so modifing a existing top document
                ...
                validateSetFields(isInsert, form, userdoc, !isInsert && embedfield).then((validatedUpdates) => {
                ...
                validateSetFields(isInsert, form, userdoc, null).then((validatedUpdates) => {
